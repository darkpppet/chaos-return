...
export type WritableWithGetDefault<T> = Writable<T> & { getDefault: () => T }; //getDefault 메소드가 있는 Writable<T>

export type NewWritable<T> = WritableWithAdd<T> & WritableWithReset<T> & WritableWithGetDefault<T>; //add, reset, getDefault 메소드가 있는 Writable<T>
